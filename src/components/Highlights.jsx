  ...
  return (
    <div className="highlights bg-[#2a3344] w-full py-12">
      <div className="highlights-content max-w-6xl mx-auto flex flex-col gap-10 px-4">
        <h1 className="text-3xl md:text-5xl font-extrabold text-[#47b8ec] text-center mb-5">
          {t("highlights.title")}
        </h1>
        ...
        <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
          ...
          <div className="highlight-item-text flex-1 text-left text-white/70">
            <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">
              {t("gamedev_highlights.extraction_title")}
            </h2>
            <p
              className="text-base md:text-xl leading-relaxed m-0 font-sans"
              dangerouslySetInnerHTML={{
                __html: t("gamedev_highlights.extraction_desc"),
              }}
            />
          </div>
        </div>
        ...
        >
          <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
            ...
            <div className="highlight-item-text flex-1 text-left text-white/70">
              <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">
                {t("gamedev_highlights.brainrot_title")}
              </h2>
              <p
                className="text-base md:text-xl leading-relaxed m-0 font-sans"
                dangerouslySetInnerHTML={{
                  __html: t("gamedev_highlights.brainrot_desc"),
                }}
              />
            </div>
        ...
        <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
          ...
          <div className="highlight-item-text flex-1 text-left text-white/70">
            <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">
              {t("highlights.maxluz_title")}
            </h2>
            <p
              className="text-base md:text-xl leading-relaxed m-0 font-sans"
              dangerouslySetInnerHTML={{ __html: t("highlights.maxluz_desc") }}
            />
          </div>
        </div>
        ...
        >
          <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
            ...
            <div className="highlight-item-text flex-1 text-left text-white/70">
              <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">
                {t("gamedev_highlights.greenfootpokemon_title")}
              </h2>
              <p
                className="text-base md:text-xl leading-relaxed m-0 font-sans"
                dangerouslySetInnerHTML={{
                  __html: t("gamedev_highlights.greenfootpokemon_desc"),
                }}
              />
            </div>
        ...
        >
          <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
            ...
            <div className="highlight-item-text flex-1 text-left text-white/70">
              <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">
                {t("gamedev_highlights.badapple_title")}
              </h2>
              <p
                className="text-base md:text-xl leading-relaxed m-0 font-sans"
                dangerouslySetInnerHTML={{
                  __html: t("gamedev_highlights.badapple_desc"),
                }}
              />
            </div>
        ...
        <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
          <div className="highlight-item-img w-full md:w-[300px] flex-shrink-0">
            <img
              src="./images/lua_terminal.gif"
              alt={t("Lua Terminal GIF")}
              className="w-full h-auto rounded-lg shadow-lg block"
            />
          </div>
          <div className="highlight-item-text flex-1 text-left text-white/70">
            <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">
              {t("highlights.terminallua_title")}
            </h2>
            <p
              className="text-base md:text-xl leading-relaxed m-0 font-sans"
              dangerouslySetInnerHTML={{
                __html: t("highlights.terminallua_desc"),
              }}
            />
          </div>
        </div>
        ...
        <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
          ...
          <div className="highlight-item-text flex-1 text-left text-white/70">
            <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">
              {t("highlights.fortes_title")}
            </h2>
            <p
              className="text-base md:text-xl leading-relaxed m-0 font-sans"
              dangerouslySetInnerHTML={{ __html: t("highlights.fortes_desc") }}
            />
          </div>
        </div>
      </div>
