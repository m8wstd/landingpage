  ...
  return (
    <div className="highlights bg-[#2a3344] w-full py-12">
      <div className="highlights-content max-w-6xl mx-auto flex flex-col gap-10 px-4">
        <h1 className="text-3xl md:text-5xl font-extrabold text-[#47b8ec] text-center mb-5">Destaques</h1>
        ...
        <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
          ...
          <div className="highlight-item-text flex-1 text-left text-white/70">
            <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">Site da Maxluz</h2>
            <p className="text-base md:text-xl leading-relaxed m-0 font-sans">
        ...
        <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
          ...
          <div className="highlight-item-text flex-1 text-left text-white/70">
            <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">Jogo no Scratch: BadApple!</h2>
            <p className="text-base md:text-xl leading-relaxed m-0 font-sans">
        ...
        <div className="highlight-item flex flex-col md:flex-row items-start gap-10 hover:scale-[1.02] transition-transform duration-300">
          ...
          <div className="highlight-item-text flex-1 text-left text-white/70">
            <h2 className="text-xl md:text-3xl font-bold text-white/87 mb-4 mt-0">Projeto: Fortes Engenharia</h2>
            <p className="text-base md:text-xl leading-relaxed m-0 font-sans">
