    ...
    return (
        <div className="contact bg-[#1a2235] w-full py-20 flex justify-center">
            <div className="contact-content w-4/5 max-w-6xl flex flex-col items-center text-center">
                <h1 className="text-3xl md:text-5xl font-extrabold text-[#47b8ec] mb-5">Contate-me!</h1>
                
                <p className="text-lg md:text-xl text-white/70 max-w-2xl leading-relaxed mb-10 text-center font-sans">
                ...
                <button onClick={handleWhatsapp} className="btn w-full md:w-[480px] flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 bg-[#47b8ec] text-black/87 px-6 md:px-10 py-4 rounded-2xl font-bold no-underline transition-transform hover:scale-105 hover:bg-[#70c1e6] mb-5 cursor-pointer">
                    ...
                    <span className='text-black text-[clamp(0.875rem,4vw,1.25rem)] md:whitespace-nowrap text-center md:text-left'>+55 27 97400-2669</span>
                </button>

                <button onClick={handleEmail} className="btn w-full md:w-[480px] flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 bg-[#47b8ec] text-black/87 px-6 md:px-10 py-4 rounded-2xl font-bold no-underline transition-transform hover:scale-105 hover:bg-[#70c1e6] mb-5 cursor-pointer">
                    <img src="./images/mail.svg" alt="Email" className="w-8 h-auto block flex-shrink-0" />
                    <span className='text-black text-[clamp(0.75rem,3.5vw,1.25rem)] md:whitespace-nowrap text-center md:text-left'>maxwellfercar@gmail.com</span>
                </button>
